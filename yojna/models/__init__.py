...
from .scheme_media import SchemeMediaModel
from .department_media import DepartmentMediaModel
...
from .document_link import DocumentlinkModel
from .pradhan import pra_dhan
from .dindayal import din_dayal
from .pramod import pramod_mah
from .upajivikesathi_kaushalya_vibhag import upajivikesathi
from .andh_vyaktinsathi_sahyabhut import andh_vyaktinsathi
from .jilha import jilha_pur
from .anusuchit_jati_navboddha import ramai_gharkul
...
from .scp_cycle import scp_cycl
