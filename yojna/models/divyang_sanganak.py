...
class divyang_sanganak(models.Model):
    name = models.CharField(max_length=200,default=None,null=True,blank=True)
    birthdate_age = models.CharField(max_length=200,default=None,null=True,blank=True)
    ...
    caste = models.CharField(default=None,null=True,blank=True,max_length=80)
    education = models.CharField(default=None,null=True,blank=True,max_length=300)
    ...
    previous_benefit = models.CharField(default=None,null=True,blank=True,max_length=30)
